...
class AddNotesFragment : BaseFragment() {
    ...
    override fun initView() {
        (activity as HomeActivity).enableDisableDrawer(DrawerLayout.LOCK_MODE_LOCKED_CLOSED)
    }
    ...
    override fun onDestroy() {
        ...
        (activity as HomeActivity).enableDisableDrawer(DrawerLayout.LOCK_MODE_UNLOCKED)
    }
